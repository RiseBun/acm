...
|---|---:|---:|---:|---:|---:|
| bc | 0.433 +/- 4.230 | 0.327 +/- 0.566 | 0.479 +/- 0.368 | 0.021 | 0.006 |
...
- Teacher-action alignment metrics still need the offline planner sanity pass before final table merging.
