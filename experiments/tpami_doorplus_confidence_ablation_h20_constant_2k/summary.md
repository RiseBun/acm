...
Setup: seeds [7, 42, 123], horizon=20, max_val_samples=2000, fp_confidence=0.05, confidence_mode=constant.

| condition | corruption | Return | CollRate | CollMean | Teacher MSE | Selected-FP-Rel@K | FP density/K |
|---|---|---:|---:|---:|---:|---:|---:|
| doorplus_uncertainty | relfp0.2 | 46.396 +/- 20.529 | 0.958 +/- 0.015 | 0.912 +/- 0.017 | 7.137 +/- 0.298 | 0.117 +/- 0.033 | 0.558 |
